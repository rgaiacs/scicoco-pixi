...
platform
: it is a combination of hardware and software, e.g. Windows AMD64 and macOS ARM64.

workspace
: it is a directory with a file named `pixi.toml` or `pyproject.toml`.
...
## Python package - Cheat sheet (1/2)
...
## Python package - Cheat sheet (2/2)
